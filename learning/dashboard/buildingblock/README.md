...
### Outline
 Setting an element outline is already available in CSS2, but in CSS3 contains the facility to offset the outline away from the element — by a value you define. It varies from a boundary in two ways:
 - Outlines don't occupy any room.
...
Multi-column layout is a new module added to CSS3 that is suitably named. It lets you to select how many columns text should be divided down into and how they should appear.
   ...
   ![](https://designshack.net/postimages/multiplecolumns.png)
...
![](https://designshack.net/postimages/multiplecolumns_heading.jpg)
